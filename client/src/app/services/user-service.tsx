// create userservice to handle states
// ref https://github.com/cornflourblue/next-js-13-app-router-mongodb-rego-login-example/blob/master/app/_services/useUserService.ts
